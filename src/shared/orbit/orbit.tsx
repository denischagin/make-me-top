        ...
        >
            {
                listPlanet.map((planet, index) => {
                    const radius = (orbitHalfWidth * orbitHalfHeight)/Math.sqrt(orbitHalfWidth * orbitHalfWidth * Math.sin(angle) * Math.sin(angle) + orbitHalfHeight * orbitHalfHeight * Math.cos(angle) * Math.cos(angle))
                    const x = Math.round(orbitWidth/2 + radius * Math.cos(angle) - defaultElementWidth/2);
                    const y = Math.round(orbitHeight/2 + radius * Math.sin(angle) - defaultElementHeight/2);
