...
import { AvatarSmall } from "../../../shared/avatars/avatarSmall/avatarSmall";
import { UsersRating } from "../../../shared/usersRating/usersRating";
        ...
        <div className="my-rating">
          ...
          <div className="my-rating-info">
            ...
            <span className="my-rating-info__user-score">
              <StarIcon /><p className="my-rating-info__user-score-num">4.8</p>
            </span>
          </div>
        </div>
        <hr style={{border: "1px solid #292929", borderBottom: "0px"}}/>
