  ...
  return (
    <>
      <div className="login">
        ...
        <Link to={explorer ? "/explorer" : "/curator"} style={{textDecoration: "none"}}>
          <PlanetButton action={() => console.log("logged")} title="Войти" />
        </Link>
        <div className="login__hint">
          Еще не зарегистрированы? <span className="login__hint-registration" onClick={() => dispatch(selectIsUserRegistered())}>Регистрация</span>
        </div>
      </div>
    </>
  );
